...
public:
    smaas();
    void maasDegistir2(bool &degisiklikIzle, bool &kaydetVar, QTableWidget *tblMaas, QTableWidget* tblHesap, QStringList listeHsp, QStringList listeClsn, QObject *obj);
