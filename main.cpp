...
{
    QSqlQuery query;
    query.exec("create table fatura(f_id integer primary key not null, f_tarih varchar,  f_isim varchar, f_matrah varchar, f_kdvorani varchar, f_kdvtutari varchar, f_tutar varchar, f_aciklama varchar, f_tur varchar, f_hesap varchar)");
